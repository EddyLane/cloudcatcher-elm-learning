...
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var initialModel = {ctor: "_Tuple2",_0: 150,_1: 150};
   var mouse = function () {    var delta = $Time.fps(30);return A2($Signal.sampleOn,delta,$Mouse.position);}();
   var update = F2(function (update,_p0) {    return update;});
   var model = A3($Signal.foldp,update,initialModel,mouse);
   ...
   var view = F2(function (_p2,_p1) {
      ...
      var w$ = _p5._0;
      var h$ = _p5._1;
      var x = $Basics.toFloat(_p4._0) - w$ / 2;
      var y = h$ / 2 - $Basics.toFloat(_p4._1);
      return A3($Graphics$Collage.collage,_p7,_p6,_U.list([A2(drawCircle,x,y)]));
   });
   var main = A3($Signal.map2,view,$Window.dimensions,model);
   return _elm.Main.values = {_op: _op,drawCircle: drawCircle,view: view,update: update,mouse: mouse,initialModel: initialModel,model: model,main: main};
};
