...
Elm.CloudcatcherThree = Elm.CloudcatcherThree || {};
Elm.CloudcatcherThree.make = function (_elm) {
   "use strict";
   _elm.CloudcatcherThree = _elm.CloudcatcherThree || {};
   if (_elm.CloudcatcherThree.values) return _elm.CloudcatcherThree.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   ...
   var modelEncoder = function (model) {
      return _U.update(model,{images: $Dict.keys(model.images),podcasts: $Dict.values(model.podcasts),visibility: $Basics.toString(model.visibility)});
   };
   var listToDict = F2(function (getKey,values) {
      return $Dict.fromList(A2($List.map,function (v) {    return {ctor: "_Tuple2",_0: getKey(v),_1: v};},values));
   });
   ...
   var ToggleSubscriptionView = {ctor: "ToggleSubscriptionView"};
   var TogglePodcastSubscribed = function (a) {    return {ctor: "TogglePodcastSubscribed",_0: a};};
   var podcastDetails = F4(function (address,subscribed,maybeImage,podcast) {
      var imageData = A2($Maybe.withDefault,"",maybeImage);
      var buttonText = subscribed ? "Unsubscribe" : "Subscribe";
      var buttonClasses = subscribed ? "btn active" : "btn btn-primary";
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("page-header")]),
      _U.list([A2($Html.h3,_U.list([]),_U.list([$Html.text(podcast.name),A2($Html.small,_U.list([]),_U.list([$Html.text(podcast.aritstName)]))]))
              ,A2($Html.img,_U.list([$Html$Attributes.src(imageData)]),_U.list([]))
              ,A2($Html.button,
              _U.list([$Html$Attributes.$class(buttonClasses),A2($Html$Events.onClick,address,TogglePodcastSubscribed(podcast.id))]),
              _U.list([$Html.text(buttonText)]))]));
   });
   var SelectPodcast = function (a) {    return {ctor: "SelectPodcast",_0: a};};
   var podcastListItem = F5(function (address,isSelected,isSubscribed,maybeImage,podcast) {
      var imageData = A2($Maybe.withDefault,"",maybeImage);
      var subscribedClass = isSubscribed ? "glyphicon glyphicon-star pull-right" : "";
      var listItemStyle = isSelected ? "list-group-item active" : "list-group-item";
      return A2($Html.a,
      _U.list([$Html$Attributes.href("#"),A2($Html$Events.onClick,address,SelectPodcast($Maybe.Just(podcast.id))),$Html$Attributes.$class(listItemStyle)]),
      _U.list([A2($Html.img,_U.list([$Html$Attributes.src(imageData)]),_U.list([]))
              ,$Html.text(podcast.name)
              ,A2($Html.span,_U.list([$Html$Attributes.$class(subscribedClass)]),_U.list([]))]));
   });
   var SubmitSearch = function (a) {    return {ctor: "SubmitSearch",_0: a};};
   var UpdateSearchInput = function (a) {    return {ctor: "UpdateSearchInput",_0: a};};
   var searchForm = F2(function (address,term) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("form-inline")]),
      _U.list([A2($Html.input,
              _U.list([$Html$Attributes.type$("text")
                      ,$Html$Attributes.$class("form-control")
                      ,$Html$Attributes.placeholder("Search for a podcast")
                      ,$Html$Attributes.value(term)
                      ,$Html$Attributes.name("search")
                      ,$Html$Attributes.autofocus(true)
                      ,A2(onInput,address,UpdateSearchInput)]),
              _U.list([]))
              ,A2($Html.button,
              _U.list([$Html$Attributes.$class("btn btn-primary"),A2($Html$Events.onClick,address,SubmitSearch(term))]),
              _U.list([$Html.text("Search")]))]));
   });
   var AddPodcasts = function (a) {    return {ctor: "AddPodcasts",_0: a};};
   var AddImage = function (a) {    return {ctor: "AddImage",_0: a};};
   var NoOp = {ctor: "NoOp"};
   var handleSearchResults = function (podcast) {
      var _p0 = podcast;
      if (_p0.ctor === "Just") {
            return AddPodcasts(A2(listToDict,function (_) {    return _.id;},_p0._0));
         } else {
            return NoOp;
         }
   };
   var ModelOutput = F8(function (a,b,c,d,e,f,g,h) {
      return {podcasts: a,visiblePodcasts: b,visibility: c,searchTerm: d,selectedPodcast: e,subscribedPodcasts: f,searchResults: g,images: h};
   });
   var Model = F8(function (a,b,c,d,e,f,g,h) {
      return {podcasts: a,visiblePodcasts: b,visibility: c,searchTerm: d,selectedPodcast: e,subscribedPodcasts: f,searchResults: g,images: h};
   });
   var Episode = function (a) {    return {title: a};};
   var Podcast = F5(function (a,b,c,d,e) {    return {name: a,aritstName: b,image: c,id: d,feedUrl: e};});
   var podcast = A6($Json$Decode.object5,
   Podcast,
   ...
   A2($Json$Decode._op[":="],"feedUrl",$Json$Decode.string));
   var podcasts = A2($Json$Decode._op[":="],"results",$Json$Decode.list(podcast));
   var getSearchResults = function (query) {
      return $Effects.task(A2($Task.map,handleSearchResults,$Task.toMaybe(A2($Http.get,podcasts,searchUrl(query)))));
   };
   var LocalImage = F2(function (a,b) {    return {uri: a,data: b};});
   var Subscribed = {ctor: "Subscribed"};
   var All = {ctor: "All"};
   var emptyModel = A8(Model,$Dict.empty,_U.list([]),All,"",$Maybe.Nothing,_U.list([]),_U.list([]),$Dict.empty);
   var update = F2(function (action,model) {
      var _p1 = action;
      switch (_p1.ctor)
      {case "AddImage": var _p2 = _p1._0;
           return {ctor: "_Tuple2",_0: _U.update(model,{images: A3($Dict.insert,_p2.uri,_p2.data,model.images)}),_1: $Effects.none};
         case "NoOp": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         case "AddPodcasts": var _p3 = _p1._0;
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,{podcasts: A2($Dict.union,_p3,model.podcasts),visiblePodcasts: $Dict.keys(_p3),searchResults: $Dict.keys(_p3)})
                  ,_1: $Effects.none};
         case "UpdateSearchInput": return {ctor: "_Tuple2",_0: _U.update(model,{searchTerm: _p1._0}),_1: $Effects.none};
         case "SubmitSearch": var _p4 = _p1._0;
           return {ctor: "_Tuple2",_0: _U.update(model,{searchTerm: _p4,visibility: All}),_1: getSearchResults(_p4)};
         case "SelectPodcast": return {ctor: "_Tuple2",_0: _U.update(model,{selectedPodcast: _p1._0}),_1: $Effects.none};
         case "ToggleSubscriptionView": return {ctor: "_Tuple2"
                                               ,_0: function () {
                                                  var getVisiblePodcasts = function (v) {
                                                     return _U.eq(v,Subscribed) ? model.searchResults : model.subscribedPodcasts;
                                                  };
                                                  var getVisiblity = function (v) {    return _U.eq(v,All) ? Subscribed : All;};
                                                  return _U.update(model,
                                                  {visibility: getVisiblity(model.visibility),visiblePodcasts: getVisiblePodcasts(model.visibility)});
                                               }()
                                               ,_1: $Effects.none};
         default: var _p5 = _p1._0;
           return {ctor: "_Tuple2"
                  ,_0: function () {
                     var unsubscribe = _U.update(model,
                     {subscribedPodcasts: A2($List.filter,function (e) {    return !_U.eq(e,_p5);},model.subscribedPodcasts)
                     ,visiblePodcasts: _U.eq(model.visibility,All) ? model.visiblePodcasts : A2($List.filter,
                     function (e) {
                        return !_U.eq(e,_p5);
                     },
                     model.subscribedPodcasts)});
                     var subscribe = _U.update(model,
                     {subscribedPodcasts: A2($List._op["::"],_p5,model.subscribedPodcasts)
                     ,visiblePodcasts: _U.eq(model.visibility,All) ? model.visiblePodcasts : A2($List._op["::"],_p5,model.visiblePodcasts)});
                     var toggle = A2($List.member,_p5,model.subscribedPodcasts) ? unsubscribe : subscribe;
                     return toggle;
                  }()
                  ,_1: $Effects.none};}
   });
   var podcastListNav = F2(function (address,visibility) {
      return A2($Html.ul,
      _U.list([$Html$Attributes.$class("nav nav-tabs")]),
      _U.list([A2($Html.li,
              _U.list([$Html$Attributes.$class(_U.eq(visibility,Subscribed) ? "active" : ""),A2($Html$Events.onClick,address,ToggleSubscriptionView)]),
              _U.list([A2($Html.a,_U.list([$Html$Attributes.href("#")]),_U.list([$Html.text("Subscriptions")]))]))
              ,A2($Html.li,
              _U.list([$Html$Attributes.$class(_U.eq(visibility,All) ? "active" : ""),A2($Html$Events.onClick,address,ToggleSubscriptionView)]),
              _U.list([A2($Html.a,_U.list([$Html$Attributes.href("#")]),_U.list([$Html.text("Search Results")]))]))]));
   });
   var podcastList = F6(function (address,visibility,entries,subscribedPodcasts,images,selectedPodcast) {
      var sorted = A2($List.sortBy,function (_) {    return _.name;},entries);
      var getImage = function (e) {    return A2($Dict.get,e.image,images);};
      var isSubscribed = function (e) {    return A2($List.member,e.id,subscribedPodcasts);};
      var isSelected = function (e) {    return _U.eq(e.id,A2($Maybe.withDefault,0,selectedPodcast));};
      var item = function (e) {    return A5(podcastListItem,address,isSelected(e),isSubscribed(e),getImage(e),e);};
      return A2($Html.div,
      _U.list([]),
      _U.list([A2(podcastListNav,address,visibility),A2($Html.div,_U.list([$Html$Attributes.$class("list-group")]),A2($List.map,item,sorted))]));
   });
   var view = F2(function (address,model) {
      var displayImage = function (e) {    return A2($Dict.get,e.image,model.images);};
      var isSubscribed = function (e) {    return A2($List.member,e.id,model.subscribedPodcasts);};
      var podcastDisplay = function () {
         var _p6 = A2($Dict.get,A2($Maybe.withDefault,0,model.selectedPodcast),model.podcasts);
         if (_p6.ctor === "Just") {
               var _p7 = _p6._0;
               return A4(podcastDetails,address,isSubscribed(_p7),displayImage(_p7),_p7);
            } else {
               return A2($Html.div,_U.list([]),_U.list([]));
            }
      }();
      var createSearchForm = A2(searchForm,address,model.searchTerm);
      var visiblePodcasts = A2($List.filterMap,function (v) {    return A2($Dict.get,v,model.podcasts);},model.visiblePodcasts);
      var createPodcastList = A6(podcastList,address,model.visibility,visiblePodcasts,model.subscribedPodcasts,model.images,model.selectedPodcast);
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("container-fluid")]),
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("col-md-6 col-sm-6 col-lg-6")]),_U.list([createSearchForm,createPodcastList]))
              ,A2($Html.div,_U.list([$Html$Attributes.$class("col-md-6 col-sm-6 col-lg-6")]),_U.list([podcastDisplay]))]));
   });
   var modelDecoder = function (model) {
      var visiblityConverter = _U.eq(model.visibility,"All") ? All : Subscribed;
      return _U.update(model,{images: $Dict.empty,podcasts: A2(listToDict,function (_) {    return _.id;},model.podcasts),visibility: visiblityConverter});
   };
   return _elm.CloudcatcherThree.values = {_op: _op
                                          ,All: All
                                          ...
                                          ,TogglePodcastSubscribed: TogglePodcastSubscribed
                                          ,ToggleSubscriptionView: ToggleSubscriptionView
                                          ,update: update
