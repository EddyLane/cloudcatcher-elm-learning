...
Elm.Cloudcatcher.make = function (_elm) {
   ...
   var NoOp = {ctor: "NoOp"};
   var initialModel = {searchInput: ""};
   var Model = function (a) {    return {searchInput: a};};
   ...
   var view = F2(function (address,model) {
      return A2($Html.div,_U.list([$Html$Attributes.$class("container")]),_U.list([pageHeader,A2(searchForm,address,model),pageFooter]));
   });
